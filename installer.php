...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20220912_sovtech_37b88254067f11926068_20220912171323_archive.zip';
        const ARCHIVE_SIZE       = '180251671';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '37b8825-12171323';
        const SECONDARY_PACKAGE_HASH = '602123d-12171323';
        const VERSION            = '1.5.0';
